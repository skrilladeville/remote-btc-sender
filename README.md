# remote-btc-sender
REMOTE BTC TRANSACTION (Core Network) Full Version 7.0.0 is an open-source software sends btc to any node (exchanger, peer-to-peer wallet, open-source, ledger wallet).
The features of REMOTE BTC TRANSACTION (Core Network) Full Version 7.0.0
